...
export const modules = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'all-orders', title: 'All Orders', loader: () => listCustomerOrders({ limit: 50 }), creator: (payload) => createCustomerOrder(payload), remover: (id) => deleteCustomerOrder(id), roles: productionRoles },
      { key: 'order-report', title: 'Order Report', loader: () => getOrderStats(), roles: accountingRoles },
    ],
  },
  {
    key: 'expenses',
  ...
  },
  {
    ...
    roles: productionRoles,
    items: [
      { key: 'suppliers', title: 'Suppliers', loader: () => purchaseApi.suppliers(), creator: (payload) => purchaseApi.createSupplier(payload), updater: (id, payload) => purchaseApi.updateSupplier(id, payload), remover: (id) => purchaseApi.deleteSupplier(id), roles: productionRoles },
      { key: 'materials', title: 'Material Catalog', loader: () => purchaseApi.materials(), creator: (payload) => purchaseApi.createMaterial(payload), updater: (id, payload) => purchaseApi.updateMaterial(id, payload), remover: (id) => purchaseApi.deleteMaterial(id), roles: productionRoles },
      ...
      { key: 'purchase-orders', title: 'Purchase Orders', loader: () => purchaseApi.orders(), creator: (payload) => purchaseApi.createOrder(payload), updater: (id, payload) => purchaseApi.updateOrder(id, payload), remover: (id) => purchaseApi.deleteOrder(id), roles: productionRoles },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'products', title: 'Products', loader: () => getProducts(), creator: (payload) => createManufacturingProduct(payload), updater: (id, payload) => updateManufacturingProduct(id, payload), remover: (id) => deleteManufacturingProduct(id), roles: productionRoles },
  ...
  },
  {
    ...
    roles: salesRoles,
    items: [
      { key: 'quotations', title: 'Quotations', loader: () => salesApi.quotations(), creator: (payload) => salesApi.createQuotation(payload), updater: (id, payload) => salesApi.updateQuotation(id, payload), remover: (id) => salesApi.deleteQuotation(id), roles: productionRoles },
      { key: 'sales-orders', title: 'Sales Orders', loader: () => salesApi.orders(), creator: (payload) => salesApi.createOrder(payload), updater: (id, payload) => salesApi.updateOrder(id, payload), remover: (id) => salesApi.deleteOrder(id), roles: productionRoles },
      { key: 'invoices', title: 'Invoices', loader: () => salesApi.invoices(), creator: (payload) => salesApi.createInvoice(payload), updater: (id, payload) => salesApi.updateInvoice(id, payload), roles: accountingRoles },
      { key: 'delivery', title: 'Delivery & Dispatch', loader: () => salesApi.delivery(), creator: (payload) => salesApi.createDelivery(payload), updater: (id, payload) => salesApi.updateDelivery(id, payload), remover: (id) => salesApi.deleteDelivery(id), roles: productionRoles },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'wastage', title: 'Wastage Prediction', loader: () => aiApi.dashboard(), roles: productionRoles },
